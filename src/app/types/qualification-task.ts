...
export abstract class QualificationTask<T extends Jsonable> extends MturkTask {
    ...
    geussTheAssociationsTask: IRFLTask;
    ...
    getTaskFromServer(index: number): Observable<any> {
        ...
        return this.type === TaskTypeEnum.GIVE_THE_CUE ? this.serverRequestService.getGiveTheCue(id, true) : this.serverRequestService.getIRFLTask(id, true);
    }
